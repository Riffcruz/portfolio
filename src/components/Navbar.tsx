  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#050811]/90 backdrop-blur-md border-b border-slate-800/80 shadow-2xl py-3.5'
          : 'bg-transparent py-5'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-3 group">
          <div className="w-9 h-9 rounded-lg bg-emerald-500 flex items-center justify-center text-slate-950 font-bold shadow-md shadow-emerald-500/20 group-hover:scale-105 transition-transform">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 text-xs font-mono font-bold rounded-lg bg-emerald-500 text-slate-950 hover:bg-emerald-400 shadow-md shadow-emerald-500/20 transition-all"
          >
      ...
      {/* Mobile Menu Overlay */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#050811]/95 border-b border-slate-800 backdrop-blur-xl px-4 pt-4 pb-6 space-y-4 shadow-2xl">
          ...
          <div className="pt-4 border-t border-slate-800 flex flex-col gap-2.5">
            ...
            <a
              href={`tel:${PORTFOLIO_DATA.personalInfo.phone}`}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-emerald-500 text-slate-950 font-bold text-xs font-mono"
            >
